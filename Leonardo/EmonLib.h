...
#define READVCC_CALIBRATION_CONST 1115000L
/*
You measured 3.30 V.
That means your internal reference is 223 counts or 0.719 V if measured with your meter.
The constant for that is 735899L
Using that in "readVcc( )", it will return 3299 mV. The difference is due to integer rounding.
The normal range should be 1024000L - 1228800L

You measured 5.00 V.
That means your internal reference is 223 counts or 1.089 V if measured with your meter.
The constant for that is 1115000L
Using that in "readVcc( )", it will return 5000 mV.
